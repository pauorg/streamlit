...
# st.dataframe(df_kart.style .highlight_max(color='lightgreen', axis='0')
...
x = st.slider('How Many Races to Show',1,len(df_racer))
...
with right_column_1:
# Bring in variable for percent won
...
#this marks the assignment portion of the program